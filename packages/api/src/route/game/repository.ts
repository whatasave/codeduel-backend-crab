import { populate, type Database, type Select } from '@codeduel-backend-crab/database';
import type { CreateGame, Game, ShareCode, UpdateGameUser, GameOfUser } from './data';
